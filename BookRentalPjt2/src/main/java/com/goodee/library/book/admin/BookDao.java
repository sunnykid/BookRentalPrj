...
public class BookDao {
	...
	public int insertBook(BookVo bookVo) {
		...
		String sql = "INSERT INTO tbl_book(b_thumbnail, "
				+ "b_name, b_author, b_publisher, b_publish_year, "
				+ "b_isbn, b_call_number, b_rental_able, b_reg_date, b_mod_date) "
				+ "VALUES (?,?,?,?,?,?,?,?,NOW(),NOW())";
	...
	public List<RentalBookVo> selectRentalBooks(){
		...
		String sql = "SELECT * FROM tbl_rental_book rb "
				...
				+ "WHERE rb.rb_end_date = '2000-01-01' "
		...
		return rentalBookVos.size() > 0 ? rentalBookVos : null;		
	}
